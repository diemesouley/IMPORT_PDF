                    ...
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <form id="addDoctor" action="secritaire-edit.php?id=<?php echo $dr['id'];?>" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group"><label id="lieu-de-naissance-4" for="username"><strong>Nom d'utilisateur</strong></label><span class="ml-2 small">(<em>Ne peut pas contenir d'espaces ou caractère spécial</em>)</span>
