...
<head>
    ...
    <title>Accueil - Gestion DU Dossier Médical</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 text-center text-white">
                <h1 class="font-weight-bold" style="text-shadow: 0px 0px;background: rgba(44,77,101,0.37);">Bienvenue sur Gestion Du dossier médical</h1>
            </div>
            <div class="col">
                <div>
                    <h1 class="text-white" style="font-size: 1.5rem;">Connectez Vous comme:</h1>
                    <div class="row">
