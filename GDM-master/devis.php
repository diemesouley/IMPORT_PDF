<?php
define('PAGETITLE', 'Liste Dossier médical');
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table table-striped my-0" id="dataTable">
                                ...
                                <tr>
                                    <th>ID-Dm</th>
                                    <th>Nom/Prénom</th>
                                    <th>Date de Naissance / Telephone</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo  $dm['datenais_patient']; ?>   /   <?php echo  $dm['tel_patient']; ?></td>
                                    <td>
                                        ...
                                        <a class="btn btn-primary m-1" role="button" href="devis.php?id=<?php echo $dm['id_dm']; ?>"><i class="fa fa-print"></i></a>
