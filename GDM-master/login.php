                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h4 class="text-dark mb-4">Gestion Cabinet Médical</h4>
                                ...
                                <form class="user" action="login.php" method="POST">
                                    ...
                                    <button class="btn btn-primary btn-block text-white btn-user" type="submit" name="login_submit">Connexion</button>
                                </form>
                            </div>
                        </div>
                    </div>
